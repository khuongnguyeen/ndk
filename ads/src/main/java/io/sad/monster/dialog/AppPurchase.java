...
public class AppPurchase {
            ...
            if (billingResult.getResponseCode() == BillingClient.BillingResponseCode.OK) {
                ...
                billingClient.querySkuDetailsAsync(params.build(), new SkuDetailsResponseListener() {
                    ...
                    public void onSkuDetailsResponse(@NonNull BillingResult billingResult, @Nullable List<SkuDetails> list) {
                        if (list != null) {
                            Log.e(TAG, "onSkuINAPDetailsResponse: " + list.size());
                            skuListINAPFromStore = list;
                            isListGot = true;
                            addSkuINAPTToMap(list);
                        }
                    }
                });
                ...
                billingClient.querySkuDetailsAsync(params.build(), (billingResult1, list) -> {
                    if (list != null) {
                        Log.e(TAG, "onSkuSubsDetailsResponse: " + list.size());
    ...
    private void addSkuINAPTToMap(List<SkuDetails> skuList) {
        for (SkuDetails skuDetails : skuList) {
    ...
    public void verifyPurchased(boolean isCallback) {
        Log.e(TAG, "isPurchased : " + listSubcriptionId.size());
        verified = false;
        if (listINAPId != null) {
...
//        Log.e(TAG, "isPurchased: " + productId);
        ...
        if (isConsumePurchase) {
            ...
            if (purchase.getPurchaseState() == Purchase.PurchaseState.PURCHASED) {
                ...
                if (!purchase.isAcknowledged()) {
                    billingClient.acknowledgePurchase(acknowledgePurchaseParams, billingResult -> Log.e(TAG, "onAcknowledgePurchaseResponse: " + billingResult.getDebugMessage()));
                }
            }
        }
    }
